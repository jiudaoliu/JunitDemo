...
public class SpringJunitAndParameterObjectTest {
	...
	public SpringJunitAndParameterObjectTest(UsersEntity  usersEntity) throws Exception {
	...
	public static Collection eventidData() {
		...
		usersEntity1.setId(1);
		usersEntity1.setAddress("hangzhou");
		usersEntity1.setPassword("aaabbb");
		usersEntity1.setCity("beijing");
		usersEntity1.setSex("1");
		usersEntity1.setUsername("hahaha");
		usersEntity1.setPhone("15154153586");
		UsersEntity usersEntity = new UsersEntity();
		usersEntity.setId(2);
		usersEntity.setAddress("HANGZHOU");
		usersEntity.setCity("BEIJING");
		usersEntity.setSex("2");
		usersEntity.setPassword("dddaaa");
		usersEntity.setUsername("hkjhkjhkjh");
		usersEntity.setPhone("15764226762");
		
		return Arrays.asList(new Object[][] { {usersEntity},{usersEntity1} });
	}

	@Test
	public void springTest() {
		UsersEntity userdentity = redisService.updateUserInfo(usersEntity);
